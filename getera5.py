...
#full_era5_ds = full_era5_ds['mean_sea_level_pressure']
start_time = datetime(2025,12,1,0)
end_time = datetime(2026,2,10,0)
era5_ds = full_era5_ds.sel(time=slice('2025-12-01 00:00:00','2026-02-10 00:00:00'))
era5_ds = era5_ds.thin(time=6) # thin to every 6 hours
era5_ds = era5_ds.isel(level=21)
...
print(era5_ds_1deg)
era5_ds_1deg.to_netcdf('era5_z500_1deg_dj2526.nc','w')
